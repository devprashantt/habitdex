		...
		<main className={styles.main}>
			<div className={styles.main__part1}>
				<div className={styles.main__part1__left}>
					...
					<SignedIn>
						<Link href="/home"><PrimaryButton>Home</PrimaryButton></Link>
					</SignedIn>
					<SignedOut>
						<Link href="/sign-up"><PrimaryButton>Get Started</PrimaryButton></Link>
					</SignedOut>
				</div>
			...
			<div className={styles.main__part2}>
				<div className={styles.main__part2__sign_in}>
					<h1>Sign In</h1>
					<Link href="/sign-in"><PrimaryButton>Sign In</PrimaryButton></Link>
				</div>
				...
				<div className={styles.main__part2__sign_up}>
					<h1>Sign Up</h1>
					<Link href="/sign-up"><PrimaryButton>Sign Up</PrimaryButton></Link>
				</div>
			</div>
			...
			<div className={styles.main__part3}>
				...
				<div className={styles.main__part3__left}>
